...
def generate(blip, image, GPT_model, n_rounds=10, n_blip2_context=-1, print_mode='chat', BLIP_max_length_token_output=100, BLIP_llm_decoding_strategy='nucleus'):
    ...
    Args:
        ...
        gpt_model (str or Blip2): the model name used to ask quetion. Valid values are 'gpt3', 'chatgpt', and their concrete model names 
...
def main(args): 
    if args.datasets == 'cityscape':
        ...
        img_size= 256 # Resize Corresponding Original Image Shape if transform is None
