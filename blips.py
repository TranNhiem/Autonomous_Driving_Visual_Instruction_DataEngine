...
class Viusal_Understanding():
    def __init__(self, device, base_model='instructblip', blip_model="OPT2.7B COCO", cache_dir='/media/rick/f7a9be3d-25cd-45d6-b503-7cb8bd32dbd5/pretrained_weights/BLIP2', load_bit=8):
        ...
        self.cache_dir = "/media/rick/f7a9be3d-25cd-45d6-b503-7cb8bd32dbd5/pretrained_weights/Instruct_blip" #cache_dir
    ...
    def initialize_model(self,):
        ...
        if self.visual_understand == 'blip2':
            processor = Blip2Processor.from_pretrained(BLIP2DICT[self.blip_model],cache_dir=self.cache_di, trust_remote_code=True,use_auth_token=True )#
    ...
    def abstract_visual_output(self, raw_image, instruction_input, llm_decoding_strategy="nucleus"):
        ...
        if llm_decoding_strategy == "beam_search":
            ...
            out = self.model.generate(**inputs, do_sample=True, max_length=256, top_p=0.95, top_k=0)
        
        elif llm_decoding_strategy =="contrastive": 
            out = self.model.generate(**inputs, max_length=512, penalty_alpha=0.6, top_k=6, repetition_penalty=1.5,)
...
if __name__ == '__main__':
    ...
    base_model = 'instructblip' #blip2 
    blip_model="vicuna-7B"#"OPT2.7B COCO" #
